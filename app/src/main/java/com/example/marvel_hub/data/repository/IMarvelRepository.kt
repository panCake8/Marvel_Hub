...
interface IMarvelRepository {
    ...
    fun searchSeries(name:String) : Single<BaseResponse<CreatorModel>>
    ...
    fun fetchSearchItems(comicName:String,seriesName:String,eventName:String): Single<List<SearchItems>>
